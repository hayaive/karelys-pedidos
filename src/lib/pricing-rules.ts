 ...
 * `CompanySettings` y usan estos como valor por defecto.
 */
...
/**
 * Precio del producto genérico. Coincide con el precio que ya tenían los 13
 ...
 *
 * Ninguno de los dos tiene umbral ni alerta: su precio vive por encima del del
 * genérico a propósito (ver `isGenericColdCake` en lib/pricing).
 */
